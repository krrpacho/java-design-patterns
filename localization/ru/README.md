...
Прежде чем нырнуть в материал, тебе следует ознакомиться с различными
...
которая скорей всего не пригодится, а просто создай простую штуку, что сможет
...
Надеемся объектно-ориентированные решения, представленные здесь будут вам 
